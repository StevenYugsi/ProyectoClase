...
namespace ProyectoClase.Controllers
{
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Registro(Usuario usuario, IFormFile Imagen)
        {
            ...
            usuario.Contraseña = Utilitarios.EncriptarClave(usuario.Contraseña);
        ...
        {
            Usuario usuarioEncontrado = await _servicioUsuario.GetUsuario(correo, Utilitarios.EncriptarClave(contraseña));
